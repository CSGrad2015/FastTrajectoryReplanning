...
public class CopyOfAStarAlgorithm extends Maze  {
	Node start;
	Node target;
	Node current;
	Node finalTarget;
	...
	int hDistance;
	static int counter;
	CopyOfBinaryHeap Open=new CopyOfBinaryHeap();
	...
	public CopyOfAStarAlgorithm(int startX,int startY,int targetX,int targetY ){
